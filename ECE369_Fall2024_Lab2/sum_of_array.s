...
# SUM=0 until the loop is broken out of where it's then assigned the value of 1
...
#$s1 is initialized with '0'. It then becomes $s1=-2 ---> $s1=-6, then finally $s1= 1.
#
# 4.   What is the purpose of register $t0 in this program?
# $t0 stores the address of the first index in the array, which is then incremented by 4 allowing to access different elements in the array
#
#
